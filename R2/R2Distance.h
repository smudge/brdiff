double R2Distance(const R2Point& point1,
                  const R2Point& point2);
double R2Distance(const R2Point& point,
                  const R2Line & line);
double R2Distance(const R2Point  & point,
                  const R2Segment& segment);

double R2Distance(const R2Line & line,
                  const R2Point& point);
double R2Distance(const R2Line& line1,
                  const R2Line& line2);
double R2Distance(const R2Line   & line,
                  const R2Segment& segment);

double R2Distance(const R2Segment& segment,
                  const R2Point  & point);
double R2Distance(const R2Segment& segment,
                  const R2Line   & line);
double R2Distance(const R2Segment& segment1,
                  const R2Segment& segment2);

double R2SignedDistance(const R2Point& point,
                        const R2Line & line);
double R2SignedDistance(const R2Line & line,
                        const R2Point& point);
