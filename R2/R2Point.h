...
public:
  ...
  friend R2Point  operator-(const R2Point& point);
  friend R2Point  operator+(const R2Point& point1,
                            const R2Point& point2);
  friend R2Point  operator+(const R2Point & point,
                            const R2Vector& vector);
  friend R2Point  operator+(const R2Vector& vector,
                            const R2Point & point);
  friend R2Vector operator-(const R2Point& point1,
                            const R2Point& point2);
  friend R2Point  operator-(const R2Point & point,
                            const R2Vector& vector);
  friend R2Point  operator*(const R2Point& point,
                            double         a);
  friend R2Point  operator*(double         a,
                            const R2Point& point);
  friend R2Point  operator/(const R2Point& point,
                            double         a);
